...
public class GenericSortingMethods {
    ...
    public static void selectionSort(Comparable[] a) {
        ...
        System.out.println("Selection sort: NumComps = "+numComps);
    }
    ...
    public static void insertionSort(Comparable a[]) {
        ...
        System.out.println("Insertion sort: NumComps = "+numComps);
    }
    ...
    public static void insert(Comparable a[], Comparable x, int end)
    {
        int k = end;
        boolean done = false;
    ...
    public static void bubbleSort(Comparable[] a)
    {
        ...
        System.out.println("Bubble sort: NumComps = "+numComps);
    }
